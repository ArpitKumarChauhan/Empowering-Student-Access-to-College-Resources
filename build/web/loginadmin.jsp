            ...
            <div style="text-align: center;" class="col-sm-12 mt-3 mb-3">
                <img style="text-align: center; height:100px;" src="images/logogpc.png">
                    ...
                    <div class="col-sm-12 p-0 mb-5">
                        <h5 style="text-align:center;"><b style="font-size:25px;color:#E67E22;">G.P.C Admin </b><b style="font-size:25px;color:#8B0000;">Login PANEL</b></h5>
                        <form action="logincodeadmin.jsp" method="post">
